...
// FallingPetals component (same as Login.jsx)
...
const Register = () => {
  ...
  return (
    <Box minHeight="100vh" display="flex" alignItems="center" justifyContent="center" sx={{ background: "linear-gradient(135deg, #e0e7ef 0%, #f5f7fa 100%)" }}>
      ...
      <Card sx={{ maxWidth: 1100, width: "100%", display: "flex", flexDirection: { xs: "column", md: "row" }, boxShadow: 6, borderRadius: 4, overflow: "hidden" }}>
        <Box flex={1} p={{ xs: 3, md: 5 }} display="flex" alignItems="center" justifyContent="center" bgcolor="#fff">
          <Box width="100%" maxWidth={350}>
            <Typography variant="h4" fontWeight={700} mb={2} textAlign="center">Register</Typography>
            <Typography color="text.secondary" mb={3} textAlign="center">Create an account to get started.</Typography>
            ...
            <Typography mt={2} textAlign="center">
              Already have an account? <Link href="/login" underline="hover" sx={{ fontWeight: 700, color: '#1a237e' }}>Login</Link>
            </Typography>
          </Box>
        </Box>
        <Box flex={1} display="flex" alignItems="center" justifyContent="center" bgcolor="#f5f7fa" p={{ xs: 3, md: 5 }}>
          <Box textAlign="center">
            <Typography variant="h5" fontWeight={700} mb={2}>Join Exalytic Today</Typography>
            <Typography color="text.secondary" mb={3}>
              Sign up and begin transforming your Excel data into actionable insights through interactive charts and AI-powered summaries.
            </Typography>
            <Box component="img" src={illustration} alt="Dashboard Illustration" sx={{ width: { xs: 220, md: 320 }, borderRadius: 3, boxShadow: 2 }} />
          </Box>
        </Box>
      </Card>
    </Box>
